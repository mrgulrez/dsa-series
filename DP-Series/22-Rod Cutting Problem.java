...
// Reason: There are N*(N+1) states
//  therefore at max ‘N*(N+1)’ new problems will be solved.
...
//  external array of size ‘N*(N+1)’. Stack Space is eliminated.
...
// of size ‘N+1’ to store only one row.